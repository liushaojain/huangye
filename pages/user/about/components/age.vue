<template>
	<view class="selectSexBox">
		<view class="ft36 ">你的年龄</view>
		<view class="ft22 c9 mt6">我们会根据你的年龄帮你匹配合适的异性</view>
		<view class="selectSex">
			<gpp-date-picker class="datePicker" @onCancel="onCancel" @onConfirm="onConfirm" :startDate="startDate" :endDate="endDate" :defaultValue="pickerDate">
...
<script>
	...
	export default {
		...
		methods:{
			comfirm(){
				this.$emit("getAge",this.pickerDate)
			},
			onCancel(){
