	...
	<view class="action-sheet" v-show="isShow">
		<view class="action-sheet-main" v-show="!isSelectFirst">
			<view class="action-sheet-content">
				...
				>
					<view><text :class="select && select.dt_id == item.dt_id ? 'blueFont': ''">{{item.dt_name}}</text><text class="money" v-show="item.money">¥{{item.money}}</text></view>
					<view v-html="item.detail" v-show="item.dt_type == 'default'"></view>
				</view>
			</view>
